...
- plot
- regression
subtitle: This week I will be looking at the Ground Game and how political mobilization
  can aid campaigns
output: 
  html_document: 
    fig_width: 5
...
- plot
- regression
>>>>>>> 21a3345b5db772864401e78baebb52736b12864c
type: ''
subtitle: 'This week I will be looking at the Ground Game and how political mobilization can aid campaigns' 
image: ''
---
```{r, setup and lab code, include=FALSE}
...
```{r, lm for turnout, include = FALSE}
=======
=======
>>>>>>> 21a3345b5db772864401e78baebb52736b12864c
...
```{r adding turnout to datasets, include=FALSE}
=======
=======
>>>>>>> 21a3345b5db772864401e78baebb52736b12864c
**Note that 2018 results in comparison to the model in lab (which included more years) has a greater correlation it seems of voter turnout and democratic major vote pct. **
...
=======
Model for predicting voter turnout for 2022 election, this model has an R-squared of 0.69. It takes state, year, president_party, cvap, and incumbency into account. I will be using this to predict the overall Democratic Major Vote Percent as well as the seat distribution for the 2022 Midterm election.
>>>>>>> 21a3345b5db772864401e78baebb52736b12864c
=======
Model for predicting voter turnout for 2022 election, this model has an R-squared of 0.69. It takes state, year, president_party, cvap, and incumbency into account. I will be using this to predict the overall Democratic Major Vote Percent as well as the seat distribution for the 2022 Midterm election.
>>>>>>> 21a3345b5db772864401e78baebb52736b12864c
...
axis.ticks.y=element_blank(),
plot.title = element_text(margin = margin(0,0,10,0), hjust = 0.5)) +
labs(fill = "DemMajorVotePct Prediction", title = "Week 6 Model Prediction8 \n DemMajorVotePct per District")
...
Democratic Major Vote Percent
Democratic Seats:

Republican Major Vote Percent:
Republican Seats:
